...
function createIconSVG(size) {
  ...
  <defs>
    <linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0%" stop-color="#0F1F15"/>
      <stop offset="100%" stop-color="#1A3524"/>
    </linearGradient>
  ...
  <text x="${cx}" y="${cx + momzSize*0.15}" text-anchor="middle" font-size="${momzSize}" fill="#22C55E" font-family="Arial Black, Arial, sans-serif" font-weight="900" letter-spacing="2">Momz<tspan fill="#3B82F6" font-family="Georgia, serif" font-weight="400" font-style="italic">Veda</tspan></text>
...
function createSimpleIcon(size) {
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 ${size} ${size}">
  <rect width="${size}" height="${size}" rx="${size*0.18}" fill="#0F1F15"/>
  <text x="${size/2}" y="${size*0.42}" text-anchor="middle" font-size="${size*0.2}" fill="#22C55E" font-family="Arial Black, sans-serif" font-weight="900" letter-spacing="1">M</text>
  <text x="${size/2 + size*0.12}" y="${size*0.42}" text-anchor="middle" font-size="${size*0.16}" fill="#3B82F6" font-family="Georgia, serif" font-style="italic">v</text>
  <rect x="${size*0.25}" y="${size*0.5}" width="${size*0.5}" height="${size*0.01}" rx="${size*0.005}" fill="#22C55E" opacity="0.5"/>
